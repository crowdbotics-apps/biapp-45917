"""
Django settings for biapp_45917 project.
...
WSGI_APPLICATION = 'biapp_45917.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "biapp_45917 API",
    "DESCRIPTION": "API documentation for biapp_45917 App",
    "VERSION": "v1",
}
